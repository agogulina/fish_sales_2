"""
Глобальная конфигурация проекта «Промо-копайлот».
Здесь собраны имена столбцов, пути, названия моделей и гиперпараметры,
чтобы все слои опирались на единый источник истины.
"""
import os
...
LLM_MODEL      = "Qwen/Qwen2.5-7B-Instruct"        # извлечение атрибутов (опционально, 4-bit)
